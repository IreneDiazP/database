...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelector('#tblProyectos tbody').addEventListener('click', async function(event) {
        ...
        if (event.target.classList.contains("editBtn") || event.target.closest(".editBtn")) {
            ...
            document.getElementById('txtIdProyectoModalEditarProyecto').value = idRegistroProyecto;
